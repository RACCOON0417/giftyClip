  ...
  return (
    <SafeAreaView style={styles.main}>
      ...
      <View style={styles.cardSelect}>
        <TouchableOpacity style={styles.cardSelect_btn} onPress={()=>setcardView(1)} ><Text style={styles.cardSelect_txt}>사용가능</Text></TouchableOpacity>
        <TouchableOpacity style={styles.cardSelect_btn} onPress={()=>setcardView(0)} ><Text style={styles.cardSelect_txt}>사용완료</Text></TouchableOpacity>
      </View>
      <View style={styles.cardList}>
          <ScrollView>
            {cardView ? ( <Cardlistview/> ) : null}
            <Cardlistview/>
          </ScrollView>
        </View>
    </SafeAreaView> 
